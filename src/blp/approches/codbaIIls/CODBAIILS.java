 ...
 * @author Abir
 */
public class CODBAIILS extends Algorithm {
    ...
    public CODBAIILS(Problem problem) {
        super(problem);
    }
        ...
        try {
            ...
            if (super.getInputParameter("populationSize") == null) {
                try {
                    ...
                    Logger.getLogger(CODBAIILS.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            if (super.getInputParameter("lNeighborhood") == null) {
                try {
        ...
        private void evalutePopulation(SolutionSet population) {
            for (int i = 0; i < population.size(); i++) {
                try {
                    ...
                    parameters.put("neighborhoods", getInputParameter("lNeighborhood"));
                    lowerlevel.addInputParameters(parameters);
                    HashMap<String, Operator> operators = new HashMap<>();
                    String[] lneighborhoods = (String[]) getInputParameter("lNeighborhood");
