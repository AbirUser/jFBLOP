...
public class ExperimentalStudy {
    ...
    public static void main(String[] args) {
        String[] problems = {"VRP"};
        String[] instances = {/*"realprob"*,/"pr01"/*,"pr02", "pr03","pr04", "pr05", "pr06", "pr07", "pr08","pr09", "pr10","p01","p02","p03", "p04", "p05","p06", "p07", "p08","p09","p10","p11","p12", "p13", "p14", "p15", "p16", "p17", "p18","p19","p20","p21"/*,p22,p23*/};
        String experimentName = "CODBALS";
            ...
            for (String problem : problems) {
                ...
                for (String instance : instances) {
                    ...
                    for (int i = 0; i < independentRuns; i++) {
                        ...
                        CODBALS codbals = initProblem(problem, instance, prb);
                        System.out.print("Running : " + problem + "/" + instance + " run : " + (i + 1) + " Please wait ...");
                        long initTime = System.currentTimeMillis();
                        Solution upperLevelSolution = codbals.execute().get(0);
                        long estimatedTime = System.currentTimeMillis() - initTime;
                        Solution lowerLevelSolution = codbals.getLowerSolution();
                        int directRationality = codbals.getDirectRationality();
                        double weightedRationality = codbals.getWeightedRationality();
                        int upperFE = codbals.getUpperFE();
                        int lowerFE = codbals.getLowerFE();
                        ...
                        System.out.println("\t done ("+codbals.getNumberOfSubPopulations()+") => "+upperLevelSolution.getFitness());
                    }
    ...
    private static CODBALS initProblem(String problem, String instance, ProblemInit prb) {
        // Problem initialization
        ...
        VRP_ vrp = new VRP_(instance, prb.getUpperSolutionType(), prb.getLowerSolutionType());
        ...
        parameters.put("maxNoImprovementLowerLevel", prb.getlMaxFE());
        parameters.put("lMaxNoImprovementLowerLevel", prb.getlMaxFE());
       // parameters.put("lNumberOfGenerationSubPopulation", prb.getlNumberOfGenerationSubPopulation());
        ...
        CODBALS algorithm = new CODBALS(prob);
...
//                lPopulationSize = 100;
                maxFE = 2000;
                lMaxFE = 2000;
                lNumberOfGenerationSubPopulation = 2;
                lP = 1;
                ...
                lowerBoundProductCost = 1.0;
                upperBoundProductCost = 4.0;
                lowerDeliveryCost = 0.5;
                upperDeliveryCost = 5.0;
                productionsAvailability = new int[numberOfPlants];
                for (int i = 0; i < productionsAvailability.length; i++) {
                    productionsAvailability[i] = 2000;
                }
