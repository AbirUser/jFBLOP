...
public class ExperimentalStudy {
    ...
    public static void main(String[] args) {
        String[] problems = {"VRP"};
        String[] instances = {"_A-n32-k5.vrp", "_A-n37-k6.vrp", "_A-n38-k5.vrp", "_A-n39-k6.vrp", "_A-n54-k7.vrp", "_A-n69-k9.vrp", "_B-n31-k5.vrp", "_B-n34-k5.vrp", "_B-n41-k6.vrp", "_B-n44-k7.vrp", "_B-n57-k7.vrp", "_B-n64-k9.vrp", "_B-n78-k10.vrp", "_E-n101-k14.vrp", "_E-n101-k8.vrp", "_E-n30-k3.vrp", "_E-n76-k14.vrp", "_E-n76-k8.vrp","pr01", "pr02", "pr03", "pr04", "pr05", "pr06", "pr07", "pr08", "pr09", "pr10", "p01", "p02", "p03", "p04", "p05", "p06", "p17", "p08", "p09", "p10", "p11", "p12", "p13", "p14", "p15", "p16", "p17", "p18", "p19", "p20", "p21"};
        String experimentName = "M-CODBA";
            ...
            for (String problem : problems) {
                ...
                for (String instance : instances) {
                    ...
                    for (int i = 0; i < independentRuns; i++) {
                        ...
                        MCODBA mcodba = initProblem(problem, instance, prb);
                        System.out.print("Running : " + problem + "/" + instance + " run : " + (i + 1) + " Please wait ...");
                        long initTime = System.currentTimeMillis();
                        Solution upperLevelSolution = mcodba.execute().get(0);
                        long estimatedTime = System.currentTimeMillis() - initTime;
                        Solution lowerLevelSolution = mcodba.getLowerSolution();
                        int directRationality = mcodba.getDirectRationality();
                        double weightedRationality = mcodba.getWeightedRationality();
                        int upperFE = mcodba.getUpperFE();
                        int lowerFE = mcodba.getLowerFE();
    ...
    private static MCODBA initProblem(String problem, String instance, ProblemInit prb) {
        // Problem initialization
        ...
        String path = System.getProperty("user.dir") + System.getProperty("file.separator") + "ExprimentalStudy" + System.getProperty("file.separator") + "_M-CODBA" + System.getProperty("file.separator") + problem + System.getProperty("file.separator") + instance + System.getProperty("file.separator");
        for (int i = 0; i < 10; i++) {
            try {
        ...
        MCODBA algorithm = new MCODBA(prob);
