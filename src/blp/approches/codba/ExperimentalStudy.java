...
public class ExperimentalStudy {
    ...
    public static void main(String[] args) {
        ...
        String[] instances = {"ins1"/*"realprob","p05", "p06", "p07", "p08","p02","p03","p04","p05","p06","p07","p08","pr01","pr02", "pr03","pr04", "pr05", "pr06", "pr07", "pr08","pr09", "pr10","p01","p02", "p03", "p04", "p05","p06", "p17", "p08","p09""p10","p11","p12", "p13", "p14", "p15", "p16", "p17", "p18","p19","p20","p21"/*,p22,p23*/};
        String experimentName = "CODBA";
            ...
            for (String problem : problems) {
                ...
                for (String instance : instances) {
                    ...
                    for (int i = 0; i < independentRuns; i++) {
                        ...
                        CODBA codba = initProblem(problem, instance, prb);
                        System.out.print("Running : " + problem + "/" + instance + " run : " + (i + 1) + " Please wait ...");
                        long initTime = System.currentTimeMillis();
                        Solution upperLevelSolution = codba.execute().get(0);
                        long estimatedTime = System.currentTimeMillis() - initTime;
                        Solution lowerLevelSolution = codba.getLowerSolution();
                        double directRationality = codba.getDirectRationality();
                        double weightedRationality = codba.getWeightedRationality();
                        int upperFE = codba.getUpperFE();
                        int lowerFE = codba.getLowerFE();
    ...
    private static CODBA initProblem(String problem, String instance, ProblemInit prb) {
        // Problem initialization
        ...
        CODBA algorithm = new CODBA(prob);
