 ...
 * @author Abir
 */
public class CODBAII_Main {

    public static void main(String[] args) {
        Problem   problem;                  // The problem to solve
        CODBAII   algorithm;                // The algorithm to use
        ...
        System.out.println("End CODBA-II");
    }
